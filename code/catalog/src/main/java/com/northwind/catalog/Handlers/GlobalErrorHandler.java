package com.northwind.catalog.Handlers;
...
public class GlobalErrorHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<ApiError> handleUnAuthenticationHandler(Exception ex, WebRequest request) {
        ApiError error = parseError(ex, request);
        error.setTitle("UnAutohrized Error");
        error.setDetail("Login with valid credentials");
        LogFactory.getLog("API").error(error.toString(), ex);
